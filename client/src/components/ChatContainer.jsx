...
const ChatContainer = ({ selectedUser, setselecteduser }) => {
  ...
  return selectedUser ? (
    <div className="h-full overflow-scroll relative backdrop-blur-lg ">
      ...
      {/* char area*/}
      <div className="flex flex-col  p-3 h-[calc(100%-120px)] overflow-y-scroll pb-6 ">
          ...
          >
            {msg.image ? (
              <img
                src={msg.image}
                alt=""
                className="max-w-[230px] border broder-gray-700 rounded-lg overflow-hidden mb-8"
              />
            ) : (
              <p
      ...
      <div className="absolute bottom-0 left-0 right-0 flex items-center gap-3 p-3">
        <div className="flex-1 flex items-center bg-gray-100/12 px-3 rounded-full "> 
          ...
          className="flex-1 text-sm p-3 rounded-lg border-none outline-none text-white placeholder-gray-400"/>
